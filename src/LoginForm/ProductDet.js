...
<p><span className='font-bold'>Customer Reviews:</span> 4.5 out of 5 stars  <span className='text-amber-400 pl-4'>★★★★☆</span> <i  className='pl-2 fa-solid fa-angle-down text-slate-900 pl-3 pr-3'></i> 16 ratings</p>
