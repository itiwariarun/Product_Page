...
function AboutCompany() {
  return (
      <div>
    <nav  className=' mb-3  truncate object h-18 bg-gray-200 object-center border-2 border-b-gray-500  ' >
<h1 className='text-3xl font-bold pl-8'>From The Manufacturer</h1>
            <div className='container  bg-gray-200 min-w-full gap-0 columns-2  h-[42rem]   h-16  opacity:-50 shadow-2xl shadow-black  '>
            <div className='container  bg-gray-200 ml-16 w-11/12 gap-0  h-[42rem]  h-16 Border opacity:-50 shadow-2xl shadow-black  '>
            <div className='container truncate leading-8 columns-2 pl-4 pt-4 bg-gray-200 min-w-full  gap-0  h-[21rem]   h-16 Border opacity:-50 shadow-2xl shadow-black  '>
<div><img src={b}/></div>
<div className='pt-8 pr-6'><h2 className='font-bold'>About Us</h2><p><span className='font-bold'>Armani Exchange </span> was created by Giorgio Armani <br/>in 1991. The brand style is inspired by the bold and <br/>youthful street culture. Made for the fast-fashioned <br/>generation, Armani focusses on unique,<br/> urban designs.</p></div>
            ...
            <div className='container truncate columns-2 leading-8 pl-4 pt-5 bg-gray-200 min-w-full  gap-0  h-[21rem]   h-16 Border opacity:-50 shadow-2xl shadow-black  '>
            <div>            <img src={a}/>
</div>
...
10 ATM: Suitable for bathing, swimming <br/>or snorkelling</p></div>
            ...
            <div className='container truncate bg-gray-200 w-11/12 ml-6 gap-0  h-[42rem]   h-16 Border opacity:-50 shadow-2xl shadow-black  '>
            <div className='container leading-8 columns-2 pl-4 pt-4 bg-gray-200 min-w-full  gap-0  h-[21rem]   h-16 Border opacity:-50 shadow-2xl shadow-black  '>
            <div>            <img src={c}/>
</div>
...
We believe that packaging is the face of a brand.<br/> Thus, our premium packages are a seamless blend<br/> of form & function and an extension of our<br/> brand promise.</p></div>
            ...
            <div className='container truncate leading-8 columns-2 pt-5 pl-4 bg-gray-200 min-w-full  gap-0  h-[21rem]   h-16 Border opacity:-50 shadow-2xl shadow-black  '>
