...
<select className='text-slate-50 bg-gray-900' name="Language" id="Language">
    ...
    <p className='text-gray-300 text-xs text-center leadin-5'>Australia Brazil Canada China France Germany Italy Japan Mexico Netherlands Poland Singapore<br/> Spain Turkey United Arab Emirates United Kingdom United States</p>
