...
<h2 className='font-bold text-2xl ml-4'>Product Specifications</h2>
<h3 className='font-bold text-lg ml-4'>Watch Information</h3>
<table className='w-full border-2 border-gray-200 m-2'>
<tr>
...
<tr>
    <td className='w-1/3border-2 border-gray-200  bg-orange-50'>
    Part Number	
